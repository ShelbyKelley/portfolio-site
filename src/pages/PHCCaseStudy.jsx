  ...
  return (
    <div className="animate-fade-in-up">
      ...
      <nav aria-label="Page sections" className="mb-10">
        <span className="text-sm text-body mr-2">Jump to:</span>
      ...
      <div className="text-body leading-relaxed space-y-8">
        <section id="problem">
          ...
          <p>
            ...
            <strong className="text-heading">single tool</strong> that answers
            "is this package healthy" in one lookup, reflecting diagnostic work
            I already do professionally.
          </p>
        </section>
        ...
        <section id="scope-decisions">
          ...
          <p>
            ...
            <strong className="text-heading">cut it</strong> in favor of linking
            directly to each advisory's own page instead. That traded real
            analytical depth for reliability and maintainability. It was the
            right call for a tool meant to be trusted at a glance, not audited
            line by line.
          </p>
        </section>
        ...
        <section id="risk-and-security">
          ...
          <p>
            ...
            <strong className="text-heading">input validation</strong> and{' '}
            <strong className="text-heading">real rate limiting</strong> at the
            infrastructure layer. Both are enforced before a request ever
        ...
        <section id="next-steps">
          ...
          <p>
            ...
            <strong className="text-heading">real usage data</strong> before
            investing further, rather than guessing at what to build next.
          </p>
        </section>
      </div>
    </div>
