// The footer's two brand marks, inlined. An icon-library dependency costs
// ~24 kB gzipped to render two paths, so keep any new icons inline too.
//
// Artwork: Font Awesome Free 7, CC BY 4.0 - https://fontawesome.com/license/free
...
// Decorative: the wrapping links carry the accessible name.
function BrandIcon({ viewBox, path, className = 'h-5 w-5' }) {
  return (
    <svg
...
export function GithubIcon(props) {
  return <BrandIcon viewBox="0 0 512 512" path={GITHUB_PATH} {...props} />
}

export function LinkedinIcon(props) {
  return <BrandIcon viewBox="0 0 448 512" path={LINKEDIN_PATH} {...props} />
}
